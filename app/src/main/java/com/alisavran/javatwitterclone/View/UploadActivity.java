...
import com.alisavran.javatwitterclone.databinding.ActivityUploadBinding;
...
public class UploadActivity extends AppCompatActivity {
    ...
    private StorageReference storageReference; // storage a kaydetme yolu
    ...
    public void uploadButtonClicked(View view){
        ...
        if (imageData != null){
            ...
            // uui universal unique id = depoya yüklenen fotolara random isim veriyor
